...
func (uc *UserCreate) SetGUID(u uuid.UUID) *UserCreate {
	uc.mutation.SetGUID(u)
	return uc
}
...
// SetGUID sets the "guid" field.
func (u *UserUpsert) SetGUID(v uuid.UUID) *UserUpsert {
	u.Set(user.FieldGUID, v)
	return u
}

// UpdateGUID sets the "guid" field to the value that was provided on create.
func (u *UserUpsert) UpdateGUID() *UserUpsert {
	u.SetExcluded(user.FieldGUID)
	return u
}
...
// SetGUID sets the "guid" field.
func (u *UserUpsertOne) SetGUID(v uuid.UUID) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetGUID(v)
	})
}
...
// UpdateGUID sets the "guid" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateGUID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateGUID()
	})
}
...
// SetGUID sets the "guid" field.
func (u *UserUpsertBulk) SetGUID(v uuid.UUID) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetGUID(v)
	})
}
...
// UpdateGUID sets the "guid" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateGUID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateGUID()
	})
}
